...
import { forwardOf, projectPoint, routeOf, type GlideState, type ProxyEntity, type RouteCourse, type Vec3 } from "./glide.ts";
...
export type HoopScene = {
  showHoops?: boolean;
  platforms?: readonly { position: Vec3; size: Vec3 }[];
